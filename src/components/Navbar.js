...
function isPartiallyActive({ isPartiallyCurrent }) {
  return isPartiallyCurrent
    ? {
        className: `ml-2 md:ml-8 inline-flex items-center px-1 pt-1 border-b-2 border-purple-500 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out"`,
      }
    : {
